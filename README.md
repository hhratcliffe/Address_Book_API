...
These are the main Python packages I used. A full list of dependencies can be found in requirments.txt.
 ...
 * GET path/contact?pageSize={}&page={}&query={}
   ...
   - EX: GET http://127.0.00.1:5000/contact?pageSize=10&page=1&query=Jim
 ...
 * POST path/contact?fullname={}&firstname={}&lastname={}&phone={}&email={}
   ...
   - EX: POST http://127.0.00.1:5000/contact?fullname=JohnDoe&firstname=John&lastname=Doe&phone=3014445762&email=JohnDoe@example.com
 ...
 * GET path/contact/{fullname}
   ...
   - EX: GET http://127.0.00.1:5000/contact/John 
 ...
 * PUT path/contact/{fullname}?firstname={}&lastname={}&phone={}&email={}
   ...
   - EX: PUT http://127.0.00.1:5000/contact/JohnDoe?firstname=John&lastname=Doe&phone=3014445799&email=JohnDoe@example.com
 
 * DELETE path/contact/{fullname}
   - Deletes the specified contact from the address book. `fullname` is the contacts unique name.
   - EX: POST http://127.0.00.1:5000/contact/John 
